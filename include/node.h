...
typedef enum {
  idNode, constNode, strNode, listNode, tupleNode, lambdaNode, panicNode,
  negNode, notNode, headNode, tailNode, lenNode, compNode, eqNode, remNode,
  bitandNode, mulNode, addNode, subNode, divNode, ltNode, shiftNode, gtNode,
  joinNode, sliceNode, bitorNode, pairNode, andNode, orNode, accessNode,
