...
int main(int argc, char *argv[])
{
  ...
  AddProjectFile(project, "test/io.ct");
  AddProjectFile(project, "test/net.ct");
  AddProjectFile(project, "test/string.ct");
  AddProjectFile(project, "test/list.ct");
  AddProjectFile(project, "test/value.ct");
  /*
